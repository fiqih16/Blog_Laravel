{{-- <footer class="py-5 footer-color mt-auto">
    <div class="container">
  ...
  <!-- Footer -->
  <footer class="mt-auto text-center text-white" style="background-color: #004d66">
    <!-- Grid container -->
    <div class="container">
      <!-- Section: Links -->
      <section class="mt-3">
      ...
      <section class="text-center mb-3">
        <a href="" class="text-white me-4 p-2">
    ...
    <div
      ...
      <p class="pt-2 text-white">© 2021 Copyright {{ config('app.name')}}</p>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
